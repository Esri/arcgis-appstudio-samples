...
Rectangle {
    ...
    Rectangle {
        ...
        ListView{
            ...
            model:ListModel {
                id:sampleItems
                ListElement { name:"Picture Marker Symbol"; url:"../Samples/PictureMarkerSymbol.qml";description:"<p>This sample demonstrates how to create PictureMarkerSymbols from the different types of image resources. <br><p></p><a href='http://geonet.esri.com/groups/appstudio/blog/2016/12/06/how-to-describe-our-resources-in-terms-of-difficulty-complexity-and-time-to-digest'><span style=' text-decoration: underline; color:#0000ff;'>Resource Level:</span></a>🍌 </p>" }

                ListElement { name:"Simple Marker Symbol"; url:"../Samples/SimpleMarkerSymbol.qml"; description:"<p>This sample demonstrates how to add a point graphic, symbolized by a red circle specified via a SimpleMarkerSymbol, to a GraphicsOverlay. <br><p></p><a href='http://geonet.esri.com/groups/appstudio/blog/2016/12/06/how-to-describe-our-resources-in-terms-of-difficulty-complexity-and-time-to-digest'><span style=' text-decoration: underline; color:#0000ff;'>Resource Level:</span></a>🍌 </p>"  }

                ListElement { name:"Simple Renderer"; url:"../Samples/SimpleRenderer.qml"; description:"<p>This sample demonstrates how to create a SimpleRenderer and add it to a GraphicsOverlay. <br><p></p><a href='http://geonet.esri.com/groups/appstudio/blog/2016/12/06/how-to-describe-our-resources-in-terms-of-difficulty-complexity-and-time-to-digest'><span style=' text-decoration: underline; color:#0000ff;'>Resource Level:</span></a>🍌 </p>"  }
