...
Column {
    ...
    property alias zoomInButton: plusButton
    property alias zoomOutButton: minusButton
    ...
    Button {
        ...
        onClicked: {
            ...
            if (homeExtent) {
                map.zoomTo(homeExtent);
            } else {
                map.zoomTo(map.fullExtent);
            }
    ...
    Button {
        ...
        visible: buttons & buttonPosition && map &&
                 map.positionDisplay.positionSource &&
                 map.positionDisplay.positionSource.valid
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                if (map.positionDisplay.positionSource.active) {
                    var mode = map.positionDisplay.mode + 1;
                    if (mode >= positionButton.maxModes) {
                        map.positionDisplay.mode = 0;
                        map.positionDisplay.positionSource.active = false;
                    } else {
                        map.positionDisplay.mode = mode;
                    }
