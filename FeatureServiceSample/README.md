...
## Simple Feature service and List view sample in AppStudio using QML and JavaScript

A simple code sample to show how to:
 - Add Feature service to a map
 - Filter feature service and show only specific types of features
 - Use ListView and ListModel to display attributes of the feature service
