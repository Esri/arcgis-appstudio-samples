    ...
    Rectangle {
        ...
        ListView{
            ...
            model:ListModel {
                ...
                ListElement { name:"Feature Collection Layer"; url:"../Samples/FeatureCollectionLayer.qml";description:"<p>This samples demonstrates how to create a new feature collection with several feature collection tables. The collection is displayed in the map as a feature collection layer.  \  <br><p></p><a href='http://geonet.esri.com/groups/appstudio/blog/2016/12/06/how-to-describe-our-resources-in-terms-of-difficulty-complexity-and-time-to-digest'><span style=' text-decoration: underline; color:#0000ff;'>Resource Level:</span></a>🍌🍌 </p>" }

                ListElement { name:"Feature Collection Layer Query"; url:"../Samples/FeatureCollectionLayerQuery.qml"; description:"<p> A query is performed using the queryFeatures() method on a ServiceFeatureTable.  The result of the query is used to instantiate an FeatureCollectionTable.  The table is added to the list of tables belonging to a FeatureCollection.  The Feature collection is then passed to a FeatureCollectionLayer.  The layer is then displayed on the map by adding it to the operationalLayers list.  <br><p></p><a href='http://geonet.esri.com/groups/appstudio/blog/2016/12/06/how-to-describe-our-resources-in-terms-of-difficulty-complexity-and-time-to-digest'><span style=' text-decoration: underline; color:#0000ff;'>Resource Level:</span></a>🍌🍌 </p>"  }
            }
