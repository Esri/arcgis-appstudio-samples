...
App{
    ...
    property string inputdata1: "Colorado.tif"
    property string outputdata1: dataPath + "/" + inputdata1

    property string inputdata2: "Shasta.tif"
    property string outputdata2: dataPath + "/" + inputdata2

    property string inputdata3: "srtm.tiff"
    property string outputdata3: dataPath + "/" + inputdata3
