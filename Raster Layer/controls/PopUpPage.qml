...
Rectangle {
    ...
    Rectangle {
        ...
        ListView{
            ...
            model:ListModel {
                id:sampleItems
                ListElement {name:"Raster Layer (Service)"; url:"../Samples/RasterLayerService.qml";description:"<p> This is a basic sample of adding an ImageServiceRaster to a Rasterlayer.  When the sample starts, an ImageServiceRaster is created and added to a RasterLayer.  The RasterLayer is then added to the map as a Basemap.  <br><p></p><a href='http://geonet.esri.com/groups/appstudio/blog/2016/12/06/how-to-describe-our-resources-in-terms-of-difficulty-complexity-and-time-to-digest'><span style=' text-decoration: underline; color:#0000ff;'>Resource Level:</span></a>🍌 </p>" }
                ListElement {name:"Raster Layer (File)"; url:"../Samples/RasterLayerFile.qml"; description:"<p>This sample demonstrates how to display local file based raster datasets with a RasterLayer.  <br><p></p><a href='http://geonet.esri.com/groups/appstudio/blog/2016/12/06/how-to-describe-our-resources-in-terms-of-difficulty-complexity-and-time-to-digest'><span style=' text-decoration: underline; color:#0000ff;'>Resource Level:</span></a>🍌🍌 </p>"  }
