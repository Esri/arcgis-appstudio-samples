   ...
   anchors{
    ...
    Component.onCompleted: {
        if ( isSubTypeField ){
            ...
            if ( hasPrototype ) {
               console.log(codedCodeArray.indexOf( defaultValue ), typeof ( codedCodeArray.indexOf( defaultValue.toString() )), codedValueArray.indexOf( codedValueArray[codedCodeArray.indexOf( defaultValue.toString() )]) )
